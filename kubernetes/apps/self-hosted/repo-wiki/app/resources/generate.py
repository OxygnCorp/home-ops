...
# relevant files. LLM-friendly, background, no truncated whole-repo dump.
...
MODEL    = os.environ.get("WIKI_MODEL", "dsv41f")
...
def commit(msg):
    ...
    subprocess.run(["git", "-C", str(REPO), "-c", "user.email=repo-wiki@oxygn.dev",
